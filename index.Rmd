...
a user to zoom into a specific are and see if it is concentrated with a specific star rating. In the future, we will be atrempting to create a shiny UI that 
