...
only_ones <- data.frame(c(filtered_las_vegas$num_each_price[1],
                          filtered_north_las_vegas$num_each_price[1],
                          filtered_henderson$num_each_price[1]))
only_twos <- data.frame(c(filtered_las_vegas$num_each_price[2],
                          filtered_north_las_vegas$num_each_price[2],
                          filtered_henderson$num_each_price[2]))
only_threes <- data.frame(c(filtered_las_vegas$num_each_price[3],
                            filtered_north_las_vegas$num_each_price[3],
                            filtered_henderson$num_each_price[3]))
only_fours <- data.frame(c(filtered_las_vegas$num_each_price[4],
...
colnames(city_df) <- c("city", "$ = Under $10", "$$ = $11-30",
                       "$$$ = $31- 60", "$$$$ = Over $61")
